...
<%
	String gids = (String) request.getAttribute("gids"); //组id
	System.out.println(gids);
	String cycle = (String) request.getAttribute("cycle"); //周期
	System.out.println(cycle);
	String beginTime = (String) request.getAttribute("beginTime"); //开始时间
	System.out.println(beginTime);
	String endTime = (String) request.getAttribute("endTime"); //结束时间
