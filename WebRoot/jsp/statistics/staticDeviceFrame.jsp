...
<FRAME name=topf src="<%=request.getContextPath()%>/jsp/statistics/staticDeviceTree.jsp?cycle=<%=cycle %>&beginTime=<%= beginTime %>&endTime=<%=endTime %>&type=<%= type %>" noResize scrolling=no>
