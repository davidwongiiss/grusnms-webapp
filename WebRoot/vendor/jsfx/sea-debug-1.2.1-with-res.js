...
*/
  ...
  function isResProtocol(id) {
    return id.indexOf('res://') === 0;
  }
...
*/
  ...
  util.isResProtocol = isResProtocol;
...
;(function(seajs, util, config) {
  ...
  Module._define = function(id, deps, factory) {
    ...
    //<<<---davidwongiiss
    // IE6.0 res:协议 空格会转变为%20
    var regex = new RegExp('%20', 'g');
    resolvedUri = resolvedUri.replace(regex, ' ');
    //--->>>
